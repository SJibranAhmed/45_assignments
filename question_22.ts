...
let usersName: string[] = ["salman", "jibran", "hasan", "haffi", "hanzala"];

//program to check are your exist or not
//this function pass boolean value
function checkingFunc(elem: number) {
  return elem !== -1;
}

let getIndex = (elem: any) => {
...
if (result) {
  ...
  console.log(
    `Hello ${userGetValue.nameOfUser.toUpperCase()} let you excited to become our member \n`
  );
}
